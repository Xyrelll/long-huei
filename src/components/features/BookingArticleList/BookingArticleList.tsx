...
export default function BookingArticleList({
  articles,
}: BookingArticleListProps) {
    ...
    >
      {articles.map((article, index) => {
        ...
        return (
          <article
            key={uniqueKey}
            className="flex flex-col pb-6 last:border-b-0"
            style={{ width: isMobile ? "100%" : "auto" }}
          >
            ...
            >
              ...
              >
                ...
                {article.tags && article.tags.length > 0 && (
                  <div className="hidden md:flex flex-wrap gap-1 mt-4 ">
