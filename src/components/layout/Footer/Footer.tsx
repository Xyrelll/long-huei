...
export default function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="w-full bg-black py-8 mb-100 flex flex-col mt-1 border-t border-white/20 md:border-t-0  relative "
    >
      {/* Copyright - Desktop: Top position */}
      <p className="copyright text-center text-white text-xs hidden md:block mb-4">
      ...
      <p className="copyright mobile-only text-center text-white text-xs mt-auto w-full">
        Copyright {new Date().getFullYear()} All Rights Reserved.
      </p>
    </footer>
  );
