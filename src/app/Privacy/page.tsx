...
export default function PrivacyPage() {
  ...
  const structuredData = {
    ...
    name: "隱私權條款 - 龍匯天下",
    description:
      "龍匯天下隱私權保護政策，說明本網站如何處理個人資料的蒐集、處理及利用方式。",
              ...
              <div className="container mx-auto">
                ...
                >
                  <ol className="breadcrumb flex items-center gap-2 text-white text-sm">
                    <li className="breadcrumb-item">
                      <Link
                        href="/"
                        className="flex items-center gap-1 hover:text-[#FFCD83] font-bold"
                      >
                ...
                <div
                  ...
                  style={{
                    ...
                    lineHeight: "1.8em",
                    fontWeight: 900,
                    letterSpacing: "0.287em",
                  }}
                >
                  <p>
                    非常歡迎您光臨「龍匯天下」（以下簡稱本網站），為了讓您能夠安心的使用本網站的各項服務與資訊，特此向您說明本網站的隱私權保護政策，以保障您的權益，請您詳閱下列內容：
                  </p>
