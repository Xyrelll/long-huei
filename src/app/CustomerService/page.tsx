...
export default function CustomerServicePage() {
  ...
  return (
    <>
      ...
      >
        <section className="article-wrap  w-full flex justify-center items-center">
          <div className="container mx-auto  ">
            {/* Articles Section */}
            <section className="articles mx-auto">
              <div className="container mx-auto px-4">
                {/* Breadcrumbs */}
                <nav
                  className="nav-breadcrumb w-full py-4 "
                  style={{
                ...
                <div
                  className="row page flex flex-col md:flex-row gap-30"
                  style={{ color: "#fff" }}
                >
                  {/* LINE Section */}
